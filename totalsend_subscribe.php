...
class TotalSendSubscribeWidget extends WP_Widget
{
	...
	public function TotalSendSubscribeWidget()
	{
		// Instantiate the parent object
		parent::__construct(false, TOTALSEND_PLUGIN_NAME);
...
class TotalSendSubscribeFront
{
	...
	public static function ts_frontend_cb()
	{
		...
		else
		{
			...
			if (isset($_POST['action']) && ('unsubscribe' == $_POST['action']))
...
class TotalSendSubscribeDispatcher
{
	...
	public function TotalSendSubscribeDispatcher()
	{
